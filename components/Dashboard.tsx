  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in relative">
      ...
      <div className="flex items-start justify-between gap-6 pl-4">
        <div className="relative group cursor-pointer mt-4 shrink-0" onClick={() => setShowManager(true)}> 
        ...
        <div className="flex-1 space-y-2 mt-2 overflow-hidden">
          <div className="flex justify-between items-baseline gap-2">
            <h1 className="text-2xl font-bold uppercase tracking-widest truncate">{player.username}</h1>
            <span className={`text-3xl font-orbitron font-bold shrink-0 ${getRankColor(player.rank)}`}>
              Rank {player.rank}
            </span>
          </div>
