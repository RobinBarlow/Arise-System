...
import { LayoutDashboard, CheckSquare, Dumbbell, ShoppingBag, Settings as SettingsIcon, Trophy } from 'lucide-react';
...
const AppContent: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'status' | 'quests' | 'dungeon' | 'shop' | 'settings' | 'leaderboard'>('status');
